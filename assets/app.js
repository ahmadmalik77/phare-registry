(function () {
    ...
    /* ── PHARE PRODUCTION (single canonical source for GitHub Pages) ──────
     * Deploy: copy/replace this entire file as index.html in your
     * phare-registry/ repo → git push → GitHub Pages (source: main / root).
     *
     * BEFORE DEPLOY: Replace the two worker URLs below with your deployed
     * Cloudflare Worker origin (e.g. https://phare-intake.xxx.workers.dev).
     *
     * Custom domain + Cloudflare proxy recommended for full CSP/HSTS.
     * This file contains ONLY the production ECDH path. No demo code.
     * ─────────────────────────────────────────────────────────────────── */
        function loadConfig() {
     ...
     *
     * 1. Content-Security-Policy — serve with a strict CSP on your host, e.g.
     *    Netlify _headers or Cloudflare transform rules:
     *
     ...
     *      img-src 'self' data:;
     *      connect-src 'self' https://phare-intake.YOUR_SUBDOMAIN.workers.dev;
